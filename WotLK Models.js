...
function PlayerType(row) {
    ...
    switch (row) {
        case "p00":
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_deathknight_bloodpresence.jpg";
            break;
        case "p01":
            playerType.id = "b";
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_deathknight_frostpresence.jpg";
            break;
        case "p02":
            playerType.id = "c";
            playerType.text = "Unholy DK";
            playerType.type = 'DPS';
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_deathknight_unholypresence.jpg";
        ...
        case "p10":
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_nature_starfall.jpg";
            break;
        case "p11":
            playerType.id = "e";
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/ability_druid_catform.jpg";
            break;
        case "p12":
            playerType.id = "f";
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_nature_healingtouch.jpg";
            break;
        case "p20":
            playerType.id = "g";
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/ability_hunter_focusedaim.jpg";
            break;
        case "p21":
            playerType.id = "h";
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/ability_hunter_aimedshot.jpg";
            break;
        case "p22":
            playerType.id = "i";
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/ability_hunter_snipershot.jpg";
            break;
        case "p30":
            playerType.id = "j";
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_holy_magicalsentry.jpg";
            break;
        case "p31":
            playerType.id = "k";
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_frost_frostbolt02.jpg";
            break;
        case "p32":
            playerType.id = "l";
            playerType.text = "Fire";
            playerType.type = 'DPS';
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_fire_firebolt02.jpg";
            break;
        case "p40":
            playerType.id = "m";
            playerType.text = "Holy";
            playerType.type = 'Healer';
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_holy_holybolt.jpg";
            break;
        case "p41":
            playerType.id = "n";
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/ability_paladin_shieldofthetemplar.jpg";
            break;
        case "p42":
            playerType.id = "o";
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_holy_auraoflight.jpg";
            break;
        case "p50":
            playerType.id = "p";
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_holy_powerwordshield.jpg";
            break;
        case "p51":
            playerType.id = "q";
            playerType.text = "Holy";
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_holy_guardianspirit.jpg";
            break;
        case "p52":
            playerType.id = "r";
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_shadow_shadowwordpain.jpg";
            break;
        case "p60":
            playerType.id = "s";
            playerType.text = "Assassination";
            playerType.type = 'DPS';
            playerType.icon = https://www.scottejaye.com/images/2022/04/ability_rogue_deadlybrew.jpg";
        ...
        case "p61":
            ...
            playerType.type = 'DPS';
            playerType.icon = https://www.scottejaye.com/images/2022/04/ability_rogue_waylay.jpg";
            break;
        case "p62":
            playerType.id = "u";
            playerType.text = "Sublety";
            playerType.type = 'DPS';
            playerType.icon = https://www.scottejaye.com/images/2022/04/ability_stealth.jpg";
            break;
        case "p70":
            playerType.id = "v";
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_nature_lightning.jpg";
            break;
        case "p71":
            playerType.id = "w";
            playerType.text = "Enhancement";
            playerType.type = 'DPS';
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_shaman_improvedstormstrike.jpg";
        ...
        case "p72":
            ...
            playerType.text = "Restoration";
            playerType.type = 'Healer';
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_nature_magicimmunity.jpg";
        ...
        case "p80":
            ...
            playerType.type = 'DPS';
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_shadow_deathcoil.jpg";
        ...
        case "p81":
            ...
            playerType.type = 'DPS';
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_shadow_metamorphosis.jpg";
        ...
        case "p82":
            ...
            playerType.type = 'DPS';
            playerType.icon = https://www.scottejaye.com/images/2022/04/spell_shadow_rainoffire.jpg";
        ...
        case "p90":
            ...
            playerType.icon = https://www.scottejaye.com/images/2022/04/ability_warrior_savageblow.jpg";
            playerType.type = 'DPS';
        ...
        case "p91":
            ...
            playerType.type = 'DPS';
            playerType.icon = https://www.scottejaye.com/images/2022/04/ability_warrior_innerrage.jpg";
        ...
        case "p92":
            ...
            playerType.text = "Protection";
            playerType.type = 'Tank';
            playerType.icon = https://www.scottejaye.com/images/2022/04/ability_warrior_defensivestance.jpg";
